                    ...
                    children: [
                      SizedBox(
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () {
                            // TODO: Tampilkan modal atau navigasi ke halaman catatan
                          },
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () {
                            if (jadwalPengiriman.statusPesanan ==
                              ...
                              showCustomSnackbar(title: 'Informasi', message: 'Pengiriman sudah dimulai untuk tujuan ini.');
                            }
                          },
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () {
                            debugPrint("Tandai Sudah Dilewati: ${tujuan.id}");
                          },
                          icon: const Icon(
                            Icons.check,
                            size: 16,
