...
class JadwalPengirimanDriver {
    ...
    factory JadwalPengirimanDriver.fromJson(Map<String, dynamic> json){ 
        return JadwalPengirimanDriver(
            ...
            tujuanKirim: json["tujuan_kirim"] == null ? [] : List<TujuanKirim>.from(json["tujuan_kirim"]!.map((x) => TujuanKirim.fromJson(x))),
            costumer: json["costumer"] == null ? null : User.fromJson(json["costumer"]),
        );
    }
